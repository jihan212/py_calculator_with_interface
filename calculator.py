...
txtDisplay = Entry(calc, font=('Helvetica',20,'bold'),
				bg='lightgoldenrodyellow',fg='black',
...
for j in range(2,5):
	for k in range(3):
		btn.append(Button(calc, width=6, height=2,
						bg='black',fg='lightgoldenrodyellow',
...
btnClear = Button(calc, text=chr(67),width=6,
				height=2,bg='lightgoldenrodyellow',
				font=('Helvetica',20,'bold')
...
btnsq = Button(calc, text="\u221A",width=6, height=2,
			bg='lightgoldenrodyellow', font=('Helvetica',
									20,'bold'),
...
btnZero = Button(calc, text="0",width=6,
				height=2,bg='black',fg='lightgoldenrodyellow',
				font=('Helvetica',20,'bold'),
...
btnPM = Button(calc, text=chr(177),width=6,
			height=2,bg='lightgoldenrodyellow', font=('Helvetica',20,'bold'),
...
lblDisplay = Label(calc, text = "Scientific Calculator",
				...
				bg='black',fg='lightgoldenrodyellow',justify=CENTER)
